const aboutContent = [
  ...
  },
  {
    ...
    second_text: `OMG Franck! is a collaborative idea from <a href="https://radiox.ch/" target="_blank">Radio X Basel <span>→</span></a>, <a href="https://www.franckareal.ch/" target="_blank">Franck Areal <span>→</span></a>, the design studio <a href="https://ozelot.ltd/" target="_blank">Ozelot Studios <span>→</span></a>, and the culinary collective No Chefs Studios. The goal is to create a "collective of collectives" together with artists, designers, chefs, DJs, and labels over the course of one week. In six days, we aim to establish a place for respectful encounters and mutual inspiration. As early as the 1990s, urban spaces were transformed into places for creative expression. Abandoned spaces were given new life. Let’s create our world in six days.`,
